...
sseo_nav <-read_csv("Data/SSEO_2020_Nav.csv")
sseo_qc <-read_csv("Data/SSEO_2020_QC.csv")
sseo_species <-read_csv("Data/SSEO_2020_Species.csv")
...
sseo_transects <- read_csv("Data/SSEO_2020_smooth_predict_lengths.csv") #This was created in ArcGIS

transect_summary <- sseo_transects %>% group_by(DIVE_NO) %>% 
